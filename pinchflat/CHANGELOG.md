...
## 2025.9.26.07 (Pinchflat v2025.6.6 modified [+ Deno, FFmpeg Update])

  * Update FFmpeg https://github.com/yt-dlp/FFmpeg-Builds/releases/download/autobuild-2026-03-17-18-27/ffmpeg-N-123524-g1c7b72cd6b-linuxarm64-gpl.tar.xz
  * Install Deno via pip
...
## 2025.9.26.00 (Pinchflat v2025.6.6)
  ...
  * Add icon, logo, changelog, and build from local Dockerfile in order to separate upstream version with app version
  * Add the options to protect the Pinchflat instance with basic auth


## v2025.6.6 (Pinchflat v2025.6.6)

  * Initial app version based on Pinchflat v2025.6.6
